...
def build_backbone(args):
    ...
    logger.info('#####################backbone_build_backbone#####################')
    position_embedding = build_position_encoding(args)
    #是否需要训练backbone（即是否采用预训练backbone）
    train_backbone = args.lr_backbone > 0
    #是否需要记录backbone的每层输出
    return_interm_layers = args.masks
    logger.info('args.backbone:{}, train_backbone:{}, return_interm_layers:{}, args.dilation:{}'.format(args.backbone, train_backbone, return_interm_layers, args.dilation))
